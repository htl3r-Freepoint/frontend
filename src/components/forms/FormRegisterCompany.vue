<template>
  <form class="col">
    ...
    <div class="col form-group">
      <div class="row">
        <label for="inputRegisterName" class="col-3 col-form-label">Company Name:</label>
        <input type="text" class="col form-control" id="inputRegisterName" v-model="this.name"
               placeholder="Company Name..." required>
      </div>
    </div>
    <div class="col form-group">
      <div class="row">
        <label for="inputRegisterName" class="col-3 col-form-label">Address:</label>
        <input type="text" class="col form-control" id="inputRegisterAddress" v-model="this.address"
